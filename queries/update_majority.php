...
<head>
    ...
    <title>PSBO Update Jurusan</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tambahkan Jurusan</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <!-- Main content -->
            <div class="content">
                <form action="update_mjr.php" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Jurusan</label>
                            <input type="text" class="form-control" name="majority_name" value="<?php echo $majority_name; ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Deskripsi Jurusan</label>
                            <input type="text" class="form-control" name="majority_description" value="<?php echo  $majority_description; ?>">
                        </div>
                    </div>
