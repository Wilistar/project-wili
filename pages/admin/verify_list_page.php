...
$result = mysqli_query($connection, "SELECT * FROM pengguna INNER JOIN majorities ON majorities.id_majority = pengguna.id_majority WHERE id_levels = 1 AND id_status = 0");
?>
<!DOCTYPE html>
<!--
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Verify List</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Verify List</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while ($user_data = mysqli_fetch_array($result)) {
                                    ...
                                    echo "&nbsp;&nbsp;";
                                    echo "<span class='badge bg-success'> <a href='../../queries/user_accept.php?id=$user_data[id]'>Accept</a></span>";
                                    echo "&nbsp;&nbsp;";
                                    echo "<span class='badge bg-danger'> <a href='../../queries/user_reject.php?id=$user_data[id]'>Reject</a></span>";
                                    echo "</td>";
                                    echo "</tr>";
                                    $number += 1;
                                }
