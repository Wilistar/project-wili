...
<head>
    ...
    <title>PSBO Tambah Jurusan</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <div class="content">
                <form action="../../queries/add_majority.php" method="POST">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Jurusan</label>
                            <input type="text" class="form-control" name="majority_name" placeholder="Enter Majority Name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Deskripsi Jurusan</label>
                            <input type="text" class="form-control" name="majority_description" placeholder="Enter Majority Description">
                        </div>
                    </div>
                    <!-- /.card-body -->
