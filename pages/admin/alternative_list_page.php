...
$result = mysqli_query($connection, "SELECT * FROM pengguna INNER JOIN majorities ON majorities.id_majority = pengguna.id_majority WHERE id_levels = 1 AND id_status = 2");
?>
<!DOCTYPE html>
<!--
...
<head>
    ...
    <title>PSBO Daftar Dicadangkan</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Daftar Dicadangkan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Daftar Dicadangkan</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 30%">Pendaftar</th>
