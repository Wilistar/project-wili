...
<head>
    ...
    <title>PSBO Detail Pendaftar</title>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <div class="btn-group btn-block">
                            <a href="../../queries/user_waiting.php?id=<?php echo $id ?>&to=admin/verify_list_page.php" class="btn btn-secondary"><b>Cancel</b></a>
                            <a href="../../queries/user_accept.php?id=<?php echo $id ?>&to=admin/accepted_list_page.php" class="btn btn-success"><b>Accept</b></a>
                            <a href="../../queries/user_alternative.php?id=<?php echo $id ?>&to=admin/alternative_list_page.php" class="btn btn-warning"><b>Alternative</b></a>
                            <a href="../../queries/user_reject.php?id=<?php echo $id ?>&to=admin/rejected_list_page.php" class="btn btn-danger"><b>Reject</b></a>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
