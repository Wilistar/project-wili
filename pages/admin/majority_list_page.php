...
<head>
    ...
    <title>PSBO Majority List</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"">Daftar Jurusan &NonBreakingSpace;<span><a href=" ./add_majority_page.php" class="btn btn-primary style=">Tambahkan</a></span></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while ($user_data = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>";
                                    echo "<span class='badge bg-primary'> <a href='./majority_detail_page.php?id=$user_data[id_majority]'>Detail</a></span>";
                                    echo "</td>";
                                    echo "</tr>";
                                    $number += 1;
                                }
